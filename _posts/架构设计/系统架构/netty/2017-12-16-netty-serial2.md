...
public abstract class Serializer {
    ...
    public <I> I read(Class<I> clz) {
        ...
        if ( clz == int.class || clz == Integer.class) {
            ...
            //针对实现了Serializer（自定义序列化接口）对象的反序列化
            try {
    ...
    public Serializer writeObject(Object object) {
        if(object == null){
            ...
            //针对实现了Serializer（自定义序列化接口）对象的序列化
